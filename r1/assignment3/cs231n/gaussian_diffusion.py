...
class GaussianDiffusion(nn.Module):
    ...
    def predict_start_from_noise(self, x_t, t, noise):
        ...
        ####################################################################
        sqrt_a_t = extract(self.sqrt_alphas_cumprod, t, x_t.shape)
        sart_one_minus_a_t = extract(self.sqrt_one_minus_alphas_cumprod, t, x_t.shape)
        x_start =(x_t - sart_one_minus_a_t * noise)/sqrt_a_t
        ####################################################################
        return x_start
    ...
    def predict_noise_from_start(self, x_t, t, x_start):
        ...
        sqrt_a_t = extract(self.sqrt_alphas_cumprod, t, x_t.shape)
        sart_one_minus_a_t = extract(self.sqrt_one_minus_alphas_cumprod, t, x_t.shape)
        pred_noise = (x_t - sqrt_a_t * x_start)/sart_one_minus_a_t
        ####################################################################
        return pred_noise
